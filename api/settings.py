...
class ApiSettings(BaseSettings):
    ...
    def set_cors_origin_list(cls, cors_origin_list, info: FieldValidationInfo):
        ...
        if isinstance(cors_origin_list, str):
            cors_origin_list = [origin.strip() for origin in cors_origin_list.split(",") if origin.strip()]
        ...
        valid_cors.append("http://localhost:8501")
        valid_cors.append("http://127.0.0.1:8501")
